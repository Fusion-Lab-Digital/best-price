...
class ProductSelectAndTextAttributes implements OptionSourceInterface
{
    ...
    private function getAttributes():array
    {
        ...
        $select = $this->connection->select()
            ...
            ->where('eav.backend_type IN (?)', ['int', 'text'])
            ->where('eav.frontend_input IN (?)', ['text', 'select'])
            ->where('eav.attribute_code NOT IN (?)', $this->attributesToFilter)
